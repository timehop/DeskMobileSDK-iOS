Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/timehop/DeskMobileSDK-iOS"
  s.author       = { 'Salesforce, Inc.' => 'mobile@desk.com' }
  s.source       = { :git => "https://github.com/timehop/DeskMobileSDK-iOS.git", :tag => s.version.to_s }
  s.platform     = :ios, '8.0'
  s.source_files = 'DeskKit/DeskKit/*.{h,m}', 'DeskKit/DeskKit/**/*.{h,m}'
  s.resources    = 'DeskKit/DeskKit/**/*.{png,storyboard}'
  s.requires_arc = true
  s.dependency 'DeskAPIClient', :git => 'https://github.com/timehop/DeskApiClient-ObjC.git', :tag => '2.0.0-timehop'
end
